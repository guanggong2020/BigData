...
# def process(num):
#     contain = []
#     request  = f'This is request : {num}'
#     print(request)
#     out = defer.Deferred()
#     reactor.callInThread(get_res,request,contain,out)
#     yield out
#     print(contain)
#     if len(contain) > 0:
#         defer.returnValue(contain[0])
#
# def get_res(request,contain,out):
#     time.sleep(2)
#     response = f'This is response for {request}'
...
c = []
c.append('111111111111')
c.append('2222222222222')
print(c)